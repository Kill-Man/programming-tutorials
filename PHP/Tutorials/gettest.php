...
echo 'Welcome, ' . $_GET['name'] . '.<br>You are ' . $_GET['age'] .
     ' years old.<br>Saved to session.<br>Check the address bar.<br>';
// Notice how when you send the information over GET, the information is shown
// in the address bar. NEVER use GET for private things such as passwords.
$_SESSION['name'] = $_GET['name'];
$_SESSION['age'] = $_GET['age'];
?>
<a href="sessiontest.php">Test $_SESSION variable.</a>
